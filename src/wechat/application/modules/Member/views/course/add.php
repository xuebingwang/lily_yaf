<div class="wrap">
    <form class="ajax-form" action="<?=U('/member/course/add')?>" method="post" before="before_submit">
        <div class="box form">
            <ul>
                <li>
                    <div class="lab cell">标题：</div>
                    <div class="cell">
                        <input id="title" name="title" type="text" class="inpt2" placeholder="输入课件标题">
                    </div>
                </li>
                <li>
