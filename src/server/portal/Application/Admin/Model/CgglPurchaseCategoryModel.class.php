 ...
 */
class CgglPurchaseCategoryModel extends Model{
...
//        $map  = array('status' => 'OK#');
        ...
        $list = $this->list_to_tree($list, $pk = 'id', $pid = 'parent_id', $child = '_');
    ...
    function list_to_tree($list, $pk='id', $pid = 'parent_id', $child = '_child') {
        // 创建Tree
        $tree = array();
        if(is_array($list)) {
            // 创建基于主键的数组引用
